...
st.set_page_config(
    page_title="Diabetes SVM Regression App",
    layout="wide"
)
...
st.title("SVM Regression on Diabetes Dataset")

st.write(
    "This application performs Support Vector "
    "Machine Regression on the Diabetes Dataset."
)
